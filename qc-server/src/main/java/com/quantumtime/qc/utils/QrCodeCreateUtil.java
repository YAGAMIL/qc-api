...
public class QrCodeCreateUtil {
    ...
    /**
     * 生成带logo和说明的二维码
     * @param outputStream 二维码储存地址
     * @param logoFile 图片文件
     * @param content 二维码内容
     * @param note 二维码说明
     * @param imageFormat 二维码格式
     */
    public static void drawLogoQRCode(OutputStream outputStream, File logoFile, String content, String note, String imageFormat) {
        try {
            ...
            log.error("生成二维码异常",e);
            throw new BizException(ErrorCodeConstant.GLOBAL_GENERATE_QRCODE_ERROR, e);
        }
    }
    ...
    public static boolean createQrCode(OutputStream outputStream, String content, int qrCodeSize, String imageFormat) throws WriterException, IOException{
        ...
        hintMap.put(EncodeHintType.CHARACTER_SET, "utf8");  // 矫错级别
    ...
    /**
     * 测试代码OutputStream outputStream, File logoFile, String content, String note, String imageFormat
     * @throws WriterException
     */
    public static void main(String[] args) throws IOException, WriterException {

        File logo = ResourceUtils.getFile("d:\\logo.png");
        drawLogoQRCode(new FileOutputStream(new File("d:\\qrcode.png")),logo,"8cfd1e55-a44f-48a8-86db-71dc41272230", "扫描二维码完成身份验证","png");
