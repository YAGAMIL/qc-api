...
public class HttpTraceLogFilter extends OncePerRequestFilter implements Ordered {
    ...
    private static final String IGNORE_TRACE_PATH_PREFIX = "/druid";
    private static final String IGNORE_CONTENT_TYPE = "multipart/form-data,application/javascript";
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (!path.startsWith(IGNORE_TRACE_PATH_PREFIX) && request.getContentType() != null && !IGNORE_CONTENT_TYPE.contains(request.getContentType())) {
                ...
                traceLog.setRequestHeadBaseInfo(request.getHeader("BaseInfo"));
    ...
    private static class HttpTraceLog {
        ...
        private String requestHeadBaseInfo;
